...
- [x] Add a real frame-sequence mascot animation pipeline with intermediate poses and static fallbacks.
  ...
  - ET pose loops: delayed idle wave, working gesture, and small completion celebration.
  - Lumo pose animation: delayed idle wave, working gesture, and completion celebration plus reverse timelines.
